...
namespace Sympli.Search.Google.Services;
    ...
    : BaseSearchEngineService(), ISearchEngineService
{
    ...
    protected override string DefaultSearchPattern => @"<div[^>]*>(https?:\/\/)?(www\.)?[-a-zA-Z0-9@:%._\+~#=]+(\.[a-zA-Z0-9()]{1,6})(.*?)<\/div>";
    protected override string SearchEngineUrl => $"https://www.google.com/search?q=";
    protected override string OffsetParams => "start";
    protected override string CountParams => "num";
